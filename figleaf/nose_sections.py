...
Automatically records coverage info for Python tests and connects it
with which with test was being run at the time.  Can be used to
...
class FigleafSections(Plugin):
    ...
    def add_options(self, parser, env=os.environ):
        ...
        parser.add_option("--figleaf-sectionfile",
                          action="store",
                          dest="figleaf_sectionfile",
                          default=None,
    ...
    def configure(self, options, config):
        ...
        if options.figleaf_sectionfile:
            self.figleaf_sectionfile = options.figleaf_sectionfile
        else:
            self.figleaf_sectionfile = DEFAULT_COVERAGE_FILE
    ...
    def finalize(self, result):
        ...
        fp = open(self.figleaf_sectionfile, 'w')
